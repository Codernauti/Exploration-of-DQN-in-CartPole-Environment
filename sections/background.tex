...
\citeauthor{Mnih2015} \shortcite{Mnih2015} demonstrated that the union of experience replay, separate target Q-network and deep convolutional network architecture are essential for outperforming the best existing reinforcement learning methods on 43 of 57 Atari 2600 games. Furthermore the agent achieves more than 75\% of the human score on 29 games.
